            ...
            <div class="col-md-3 top_brand_left">
                <div class="hover14 column">
                    <div class="agile_top_brand_left_grid">
                        ...
                        <div class="tag">
                            <?= \yii\helpers\Html::img("@web/images/tag.png", ['alt' => 'offer', 'class' => 'img-responsive']) ?>
                        </div>
                        <div class="agile_top_brand_left_grid1">
                            <figure>
                                <div class="snipcart-item block" >
                                    ...
                                    <a href="<?= \yii\helpers\Url::to(['cart/add', 'id' => $offer->id]) ?>" class="button add-to-cart" data-id="<?= $offer->id ?>">Добавить в корзину</a>
