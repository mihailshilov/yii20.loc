...
<div class="products-breadcrumb">
    <div class="container">
        <ul>
            ...
            <li>
                <a href="<?= \yii\helpers\Url::to(['category/view', 'id' => $product->category->id]) ?>"><?= $product->category->title ?></a><span>|</span>
            </li>
            <li><?= $product->title ?></li>
        </ul>
    </div>
    ...
    <div class="w3l_banner_nav_right">
        ...
        <div class="agileinfo_single">
            ...
            <div class="col-md-4 agileinfo_single_left">
                <?= \yii\helpers\Html::img("@web/products/{$product->img}", ['alt' => 'offer', 'class' => $product->title, 'id' => 'example', 'class' => 'img-responsive']) ?>
            </div>
