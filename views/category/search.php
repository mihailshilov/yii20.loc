                                            ...
                                            <div class="snipcart-item block">
                                                <div class="snipcart-thumb">
                                                    <a href="<?= \yii\helpers\Url::to(['product/view', 'id' => $product->id]) ?>">
                                                        <?= \yii\helpers\Html::img("@web/products/{$product->img}", ['alt' => 'offer', 'class' => $product->title]) ?>
                                                    </a>
                                                    <p><?= $product->title ?></p>
                                                    <h4><?= $product->price ?>
                                                ...
                                                <div class="snipcart-details">
                                                    <a href="<?= \yii\helpers\Url::to(['cart/add', 'id' => $product->id]) ?>" class="button add-to-cart" data-id="<?= $product->id ?>">Добавить в корзину</a>
                                                </div>
                                            </div>
                                        </figure>
                                    </div>
